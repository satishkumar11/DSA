...
class TwoSum {
    ...
    public static int[] twoSumPractise(int[] nums, int target) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(twoSumPractise(new int[] { 2, 7, 11, 15 }, 9))); // [0, 1]
        System.out.println(Arrays.toString(twoSumPractise(new int[] { 3, 2, 4 }, 6))); // [1, 2]
        System.out.println(Arrays.toString(twoSumPractise(new int[] { 3, 3 }, 6))); // [0, 1]
    }
}
